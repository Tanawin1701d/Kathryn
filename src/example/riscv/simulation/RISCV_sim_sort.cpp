...
//            }
        ...
        void RiscvSimInterfaceSort::writeFetchSlot(FlowBlockPipeBase* pipblock) {
            ...
            slotWriter.addSlotVal(RISC_FETCH_SORT, "isFin " + std::to_string(ull(_core.fetch.readFin)));
            slotWriter.addSlotVal(RISC_FETCH_SORT, "isEn " + std::to_string(ull(_core.fetch.readEn)));
        ...
        void RiscvSimInterfaceSort::writeDecodeSlot(FlowBlockPipeBase* pipblock) {
            ...
            if (_core.decode.decodeBlk->getSimEngine()->isBlockRunning()) {
                ...
                slotWriter.addSlotVal(RISC_DECODE_SORT, cvtNum2HexStr(next_pc));
            }else{
        ...
        void RiscvSimInterfaceSort::writeExecuteSlot(FlowBlockPipeBase* pipblock) {
            ...
            slotWriter.addSlotVal(RISC_EXECUTE_SORT, "readFin " + std::to_string(ull(_core.execute.readFn)));
            slotWriter.addSlotVal(RISC_EXECUTE_SORT, "readEn " + std::to_string(ull(_core.execute.readEn)));
        ...
        void RiscvSimInterfaceSort::writeWbSlot(FlowBlockPipeBase* pipblock) {
            ...
            (RISC_WB_SORT, std::to_string(ull(wbReg.val)));
        }
