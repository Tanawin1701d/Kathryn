    ...
    namespace riscv{
        ...
        public:
            ...
            explicit Decode(UOp& uop): _uop(uop){
                ...
                ////// load/store/and////////////////////////////////////////////////////////////////
                /////////////////////////////////////////////////////////////////////////////////////
                repo.addDecRule("ldst", "<12-i1-0-12><5-rs0><1-ufb><2-ufa><5-rd0><0000011>").
                ad("<ufa>",{{"<000>", "lsb"}, {"<001>", "lsh"}, {"<010>", "lsw"}}).
                ad("<ufb>", {{"<1>", "sign"}});

                repo.addDecRule("ldst", "<7-i1-5-12><5-rs1><5-rs0><3-ua><5-i1-0-5><0100011>").
                ...
                ////// 001 jalr
                repo.addDecRule("jal", "<12-rs1-0-12><5-rs0><000><5-rd0><1100111>");
                ////// 011 jal
                repo.addDecRule("jal", "<1-i1-20-21><10-i1-1-11><1-i1-11-12><8-i1-12-19><5-rd0><1101111>")
                .adm({"needpc"});
                /////////////////////////////////////////////////////////////////////////////////////
                ////// op/opImm ////////////////////////////////////////////////////////////////////
                ////////////////////////////////////////////////////////////////////////////////////
                ...
                ad("<ua>", {{"<000>","add" }, {"<010>","slt"},{"<011>","sltu"},
                            ...
                            {"<001>","sl"  }, {"<101>","sr" }})
                .ad("<s-30-31><ua>", {"<1><101>", "sra"});
                ////// 101 auipc/lui
                repo.addDecRule("ldpc", "<20-i1-12-32><5-rd0><0010111>").adm({"needpc"});
                repo.addDecRule("ldpc", "<20-i1-12-32><5-rd0><0100011>" );
