    ...
    public:
        void start(PARAM& params){
            ...
            WSlotWriter slotWriterKride(slotColumnNames, slotColumnWidth,
                params["prefix"] + testTypes[0] + "/oslotKride.sl",
                2500);
            WSlotWriter slotWriterRide (slotColumnNames, slotColumnWidth,
                params["prefix"] + testTypes[0] + "/oslotRide.sl",
                2500);

            ResultWriter resultWriterKride(params["prefix"] + testTypes[0] + "/kathrynKrideResult");
            ResultWriter resultWriterRide(params["prefix"] + testTypes[0] + "/verilatorRideResult");
