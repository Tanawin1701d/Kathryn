...
namespace kathryn::o3{
        ...
        inline void immGen(Reg& instr, Reg& immType, Wire& result){
            ...
            zif (immType == IMM_I)  {result = g(instr(25, 32), instr(21, 25), instr(20)).sext(DATA_LEN);}
            zelif(immType == IMM_S) {result = g(instr(25, 32), instr(8, 12) , instr(7) ).sext(DATA_LEN);}
            ...
            zelse                   {result = g(instr(25, 32), instr(21, 25), instr(20)).sext(DATA_LEN);}
        }
