...
namespace kathryn::o3{
        ...
        inline SlotMeta smDecBase {
            {inst              , invalid           , immType    , aluOp          , rsEnt, /////// operation
             isBranch          , predAddr         , spec        , specTag        , illLegal, ////// branch
             rdIdx             , rdUse             ,    /////// destination
             rsIdx_1           , rsSel_1           , rsUse_1     , /////// src1
             rsIdx_2           , rsSel_2           , rsUse_2     , /////// src2
             dmemSize         , dmemType         , //////// memory
             mdReqOp         , mdReqInSigned1, //////// multiplication
             mdReqInSigned2, mdReqOutSel
            },
        ...
        inline SlotMeta smRsvMul {
            {mdReqInSigned1, mdReqInSigned2, mdReqOutSel   },
