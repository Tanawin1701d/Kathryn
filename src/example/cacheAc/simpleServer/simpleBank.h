...
namespace kathryn::cacheServer{
    ...
    public:
        ...
        explicit SimpleBank(KV_PARAM& kvParam, int suffixBit, int bankId):
        CacheBankBase (kvParam, 1 << suffixBit, bankId),
        _suffixBit    (suffixBit),
        inputItf      (kvParam, _bankId),
        outputItf     (kvParam, inputItf),
        ...
        void decodePacket() override{
            ...
            cif (inputItf.nextIsLoad()){ strack("loading" + std::toString(_bankId)) ////// is load /////try until outgress is recv
            ...
            }celse{ strack("writing" + std::toString(_bankId)) //// is write
                ///// write to memory now
...
//                        writeMem(inputInBankKey, inputItf.value);
        ...
        BankInputInterface*  getBankInputInterfacePtr () override{return &inputItf;}
        BankOutputInterface*getBankOutputInterfacePtr() override{return &outputItf;}
