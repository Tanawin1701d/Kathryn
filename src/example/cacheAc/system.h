        ...
        public:
            ...
            void initServer(){
                ...
                for (int bankId = 0; bankId < amtBank; bankId++) {
                    _banks         .pushBack(genBank(bankId));
                    _bankInputItfs .pushBack(_banks[bankId]->getBankInputInterfacePtr());
                    _bankOutputItfs.pushBack(_banks[bankId]->getBankOutputInterfacePtr());
                }
                _ingress  =  genIngress();
