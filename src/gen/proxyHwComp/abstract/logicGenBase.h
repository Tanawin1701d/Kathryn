...
namespace kathryn{
    ...
    public:
        ...
        ///////// getter
        [[nodiscard]] ModuleGen*getModuleGenPtr() const{
            assert(_mdGenMaster != nullptr);
            return _mdGenMaster;
        }
        [[nodiscard]] Identifiable*getIdentPtr()    const {return _ident;}
    ...
    public:
        ...
        virtual LogicGenBase* getLogicGenPtr()        = 0;
    };
