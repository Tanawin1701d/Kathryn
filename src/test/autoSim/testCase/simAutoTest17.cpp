...
namespace kathryn{
    ...
    public:
        ...
        sim17(testSimMod17* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              200,
...
//
            sim{
                ull testVal = 1;
                testAndPrint("test recur nest d", (ull)_md->d, testVal);
                testAndPrint("test recur nest e", (ull)_md->e, testVal);
                testAndPrint("test recur nest f", (ull)_md->f, testVal);
            };
...
//            };
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim17 simulator((testSimMod17*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
