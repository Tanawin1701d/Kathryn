...
namespace kathryn{
    ...
    public:
        ...
        sim16(testSimMod16* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              200,
...
//            };
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim16 simulator((testSimMod16*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
