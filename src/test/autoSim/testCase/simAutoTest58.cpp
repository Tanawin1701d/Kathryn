...
namespace kathryn{
    ...
    public:
        ...
        void describeCon() override{
            ...
            // conEndCycle();
            for (int i = 2; i <= 8; i++){
                testAndPrint("a value " + std::toString(i)  , ull(_md->a), i);
                testAndPrint("b value " + std::toString(i)  , ull(_md->b), 0);
                conNextCycle(1);
                conEndCycle();
            }
            ...
            testAndPrint("a value " + std::toString(24)  , ull(_md->a), 24);
            testAndPrint("b value " + std::toString(0)  , ull(_md->b), 0);
            conNextCycle(1);
            conEndCycle();
            testAndPrint("a value " + std::toString(48)  , ull(_md->a), 48);
            testAndPrint("b value " + std::toString(48)  , ull(_md->b), 48);
        }
