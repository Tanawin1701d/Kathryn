...
namespace kathryn{
    ...
    public:
        ...
        sim19(testSimMod19* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              300,
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim19 simulator((testSimMod19*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
