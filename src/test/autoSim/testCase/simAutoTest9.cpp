...
namespace kathryn{
    ...
    public:
        ...
        sim9(testSimMod9* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              200,
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim9 simulator((testSimMod9*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
