...
namespace kathryn{
    ...
    public:
        ...
        sim25(testSimMod25* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              200,
...
//            }
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim25 simulator((testSimMod25*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
