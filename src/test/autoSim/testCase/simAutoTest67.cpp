...
namespace kathryn{
    ...
    public:
        ...
        void describeCon() override{
            ...
            conNextCycle(10);
            testAndPrint("check r1  equal to " + std::toString( 64), ull(_md->r1 ), 64 );
            testAndPrint("check r2  equal to " + std::toString(128), ull(_md->r2 ), 128);
            testAndPrint("check res equal to " + std::toString(  0), ull(_md->res), 0  );
            // for (int i = 1; i < 5; i++){
            //     conEndCycle();
