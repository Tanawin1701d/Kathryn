...
namespace kathryn{
    ...
    public:
        ...
        sim4(testSimMod4* md, int idx, const std::string& prefix, SimProxyBuildMode simProxyBuildMode):SimAutoInterface(idx,
                                              100,
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode simProxyBuildMode) override{
            ...
            startModelKathryn();
            sim4 simulator((testSimMod4*) &d, _simId, prefix, simProxyBuildMode);
            simulator.simStart();
        }
