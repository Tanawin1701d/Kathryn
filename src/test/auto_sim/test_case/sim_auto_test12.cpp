...
namespace kathryn{
    ...
    class test_sim_mod12: public Module{
    public:
        ...
        explicit test_sim_mod12(int x): Module(){}
    ...
    ///static std::string vcd_path = "/media/tanawin/tanawin1701e/project2/Kathryn/KOut/sim_auto_test12.vcd";
    ////static std::string profile_path = "/media/tanawin/tanawin1701e/project2/Kathryn/KOut/prof_auto_test12.vcd";
    ...
    public:
        ...
        sim12(test_sim_mod12* md, int idx, const std::string& prefix, SimProxyBuildMode sim_proxy_build_mode):SimAutoInterface(idx,
                                              200,
        ...
        void sim_assert() override{
            ...
            inc_cycle(6);
            sim {
                // ValRep test_val = NumConverter::create_val_rep(67, 0b100, 0);
...
//            };
    ...
    public:
        ...
        void start(std::string prefix, SimProxyBuildMode sim_proxy_build_mode) override{
            m_mod(d, test_sim_mod12, 1);
            //d.set_vcd_reg_pol(MDE_REC_ONLY_USER);
            start_model_kathryn();
            sim12 simulator((test_sim_mod12*) &d, _simId, prefix, sim_proxy_build_mode);
            simulator.sim_start();
        }
