...
namespace kathryn{
    ...
    void MemEleHolderSimEngine::proxyBuildInit(){
        ...
        dep.pushBack(_master->_indexer->getLogicSimEngineFromOprPtr());
    ...
    void MemEleHolderSimEngine::createOpReadMode(CbBaseCxx& cb){
        ...
        ValR memValR = _master->_master->getSimEnginePtr()->getValRep();
    ...
    void MemEleHolderSimEngine::createOpEndCycle(CbBaseCxx& cb){
        ...
        if (_master->isWriteMode()){
            ...
            ValR memBlkValR = _master->_master->getSimEnginePtr()->getValRep();
