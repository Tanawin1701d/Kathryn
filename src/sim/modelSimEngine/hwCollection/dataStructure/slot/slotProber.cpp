...
namespace kathryn{
    ...
    SlotSimInfo64 SlotSimProbe::getCurValues(){
        ...
        for (int idx = 0; idx < slot->getNumFieldPtr(); idx++){
    ...
    FieldSimInfo64 SlotSimProbe::getCurValue(std::string varName){
        ...
        int idx = slot->getMeta().getIdxPtr(varName);
