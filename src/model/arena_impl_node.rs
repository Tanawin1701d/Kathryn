...
impl ModelArena {
    ...
    pub fn get_start_node     (&self, h: ArenaHandle) -> &StartNode      { self.start_nodes     .get(h) }
    ...
    pub fn get_start_node_mut     (&mut self, h: ArenaHandle) -> &mut StartNode      { self.start_nodes     .get_mut(h) }
    ...
    pub fn get_node_exit_opr       (&self, ident: &NcpIdent) -> Option<HcpIdent> { self.get_ncp_node(ident).get_exit_opr() }
    pub fn get_node_state_operating(&self, ident: &NcpIdent) -> Option<HcpIdent> { self.get_ncp_node(ident).get_state_operating() }
