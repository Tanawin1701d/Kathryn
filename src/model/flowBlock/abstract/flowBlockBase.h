...
namespace kathryn {
    ...
    public:
        ...
        FlowBaseSimEngine* getSimEnginePtr() override{
        ...
        virtual void addIntSignal(INT_TYPE type, Operable* signal){
            ...
            intSignals[type].pushBack(signal);
        }
        ...
        [[nodiscard]]std::string getMdIdentVal() override{
            return FBT_to_string(getFlowType()) + "_blockId_" + std::toString(_fbId);
        }
    };
