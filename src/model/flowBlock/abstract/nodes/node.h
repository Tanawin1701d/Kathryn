...
namespace kathryn {
    ...
    struct Node : public ModelDebuggable
        ...
        void addDependNode(Node* srcNode, Operable* cond) {
            ...
            nodeSrcs.pushBack({srcNode, cond});
        }
        ...
        void addCycleRelatedReg(CtrlFlowRegBase* ctrlReg){
            ...
            relatedCycleConsumeReg.pushBack(ctrlReg);
        }
        ...
        Node*getHoldNodePtr() const { return holdNode; }
        ...
        Operable* bindWithHoldIfHold(Operable* rawExit){
            ...
            if (isThereHold()){
                return &((*rawExit) & (~(*getHoldNodePtr()->getExitOprPtr())));
            }
            return rawExit;
        }
        ...
        virtual Operable*getExitOprPtr(){ return nullptr; };
        virtual Operable*getStateOperatingPtr(){return nullptr;}
        ...
        std::string getMdIdentVal() override{
            std::string ret = NT_to_string(nodeType) + " @ " + std::toString((ull)this);
            return ret;
        }
