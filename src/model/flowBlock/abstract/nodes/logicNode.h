...
namespace kathryn{
    ...
    struct PseudoNode : Node{
        ...
        explicit PseudoNode(int exprSize, LOGIC_OP joinOp) :
                Node(PSEUDO_NODE),
                _pseudoAssignMeta(new expression(exprSize)),
                _joinOp(joinOp){
        ...
        void assign() override{
            ...
            for (auto nodeSrc: nodeSrcs){
                ...
                oprPerSrc = nodeSrc.dependNode->getExitOprPtr();
        ...
        Operable*getExitOprPtr() override{return _pseudoAssignMeta;}
    ...
    struct DummyNode : Node{
        ...
        Operable*getExitOprPtr() override{return _value;}
