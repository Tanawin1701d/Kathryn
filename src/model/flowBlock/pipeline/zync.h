...
//#define zyncCon(cond)        for(auto kathrynBlock = new FlowBlockZyncBase(&cond);             kathrynBlock->doPrePostFunction(); kathrynBlock->step())
...
namespace kathryn{
    ...
    public:
        ...
        StateNode*getPreSendNodePtr() { assert(prepSendNode != nullptr); return prepSendNode;}
