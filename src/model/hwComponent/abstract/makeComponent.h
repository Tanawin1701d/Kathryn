...
#define mMod(name, TypeName, ...) Module&   name = _make<TypeName>(#name, true, __VA_ARGS__)
#define mWire( name, argument)    Wire&     name = _make<Wire>    (#name, true,argument)
#define mReg( name, argument)     Reg&      name = _make<Reg>     (#name, true, argument)
#define mVal(name, ...)           Val&      name = _make<Val>     (#name, true, __VA_ARGS__)
#define mMem(name, depth, width)  MemBlock& name = _make<MemBlock>(#name, true, depth, width)
#define g(...) makeNest(true,__VA_ARGS__)
#define mBox(name, TypeName) TypeName& name = _make<TypeName>(#name, true)
