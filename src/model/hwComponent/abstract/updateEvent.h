...
namespace kathryn{
    ...
    struct UpdatePool{
        ...
        sizeT     size   () const{return events.size();}
    ...
    struct UpdateEventSwitch: UpdateEventBase{
        ...
        UpdateEventBase*getSubStmtsPtr(int idx) const{
