...
namespace kathryn{
    ...
    public:
         ...
         *
         */
        WireSlot gen_dyn_wire_slotBase(Operable& requiredIdx, bool isOneHotIdx); //// oneHotIdx will determine the the rowId by bit Idx in the requiredIdx
        WireSlot gen_dyn_wire_slotBiIdx(Operable& binIdx);
        WireSlot gen_dyn_wire_slotOHIdx(Operable& ohIdx);
