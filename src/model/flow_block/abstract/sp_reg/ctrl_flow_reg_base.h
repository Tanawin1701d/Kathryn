...
namespace kathryn{
    ...
    public:
        ...
        explicit CtrlFlowRegBase(int reg_size,
                                 bool init_com,
            ...
            get_sim_engine_ptr()->set_flow_block_iden(true);
        }
        ...
        virtual UpdateEventBase* add_depend_state(Operable* depend_state, Operable* activate_cond, CLOCK_MODE cm) = 0;
