# tc20 — pip/zync pipeline baseline: 3 stages chained through four shared arbiters,
...
NAME = "tc20_pip_zync_baseline"

RUN_CYCLES = 40                         # cycles to run after reset is released


# ---- model -------------------------------------------------------------------
class tc20_pip_zync_baseline(Module):
    @init
